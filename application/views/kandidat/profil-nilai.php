	...
	<div class="row">
		<div class="col-md-3 col-md-offset-1">
			<div class="row profil-row">
				<div class="col-md-12">
					<h3>Nilai</h3><hr>
					<label for="usr">Esai</label>
  					<input type="text" class="form-control" id="usr" placeholder="range 1-100">

  					<label for="usr">Pencapaian</label>
  					<input type="text" class="form-control" id="usr" placeholder="range 1-100">

  					<label for="usr">Proyek</label>
  					<input type="text" class="form-control" id="usr" placeholder="range 1-100">

  					<label for="usr">Kelengkapan Berkas</label>
  					<input type="text" class="form-control" id="usr" placeholder="range 1-100">
